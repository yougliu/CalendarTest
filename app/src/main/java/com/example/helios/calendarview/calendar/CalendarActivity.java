...
import com.example.helios.calendarview.calendar.adapter.EventListViewAdapter;
import com.example.helios.calendarview.calendar.bean.CalendarEvent;
import com.example.helios.calendarview.calendar.calendar.CreateEventActivity;
import com.example.helios.calendarview.calendar.widget.EventListView;
 ...
 * 
 */
public class CalendarActivity extends Activity implements View.OnClickListener,OnItemClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mListView.addHeaderView(view);//必须再调用setAdapter才能其作用
		mAdapter = new EventListViewAdapter(this,mEvents);
